...
const Button = ({
  ...
  const variants = {
    ...
    error: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 shadow-sm hover:shadow',
    ...
    link: 'text-blue-600 hover:text-blue-700 hover:underline focus:ring-blue-500 dark:text-blue-400',
  };
